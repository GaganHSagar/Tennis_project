...
if __name__ == "__main__":
    ...
    out = cv2.VideoWriter(f"tested_video_wed.mp4", cv2.VideoWriter_fourcc(
            *'mp4v'), 30, (640, 640))
    ...
    while cap.isOpened():
        ...
        ##################################
        print("human_pose_extractor.keypoints_pixels_frame:  ",human_pose_extractor.keypoints_pixels_frame)
        print("human_pose_extractor.keypoints_pixels_frame.shape:  ",human_pose_extractor.keypoints_pixels_frame).shape
        ...
        if FRAME_ID ==1:
          ...
          out = cv2.VideoWriter(f"tested_wed.mp4", cv2.VideoWriter_fourcc(
