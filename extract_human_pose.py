...
class HumanPoseExtractor:
    ...
    def extract(self, frame):
        ...
        ####################
        # print("HumanPoseExtractor.keypoints_with_scores, shape:  ",self.keypoints_with_scores,self.keypoints_with_scores.shape)
        self.keypoints_pixels_frame = self.roi.transform_to_frame_coordinates(
            self.keypoints_with_scores
        )
        # print("HumanPoseExtractor.keypoints_pixels_frame, shape:    ",self.keypoints_pixels_frame,self.keypoints_pixels_frame.shape)
        ####################
